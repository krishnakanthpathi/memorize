...
class TestMarkdownHandler(unittest.TestCase):
    ...
    def test_create_read_delete_markdown_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            # Patch MEMORIES_CATEGORIES for this test
            import storage.markdown_handler
            original_categories = storage.markdown_handler.MEMORIES_CATEGORIES
            storage.markdown_handler.MEMORIES_CATEGORIES = {"personal": test_personal_dir}
            ...
            try:
                ...
                storage.markdown_handler.MEMORIES_CATEGORIES = original_categories
